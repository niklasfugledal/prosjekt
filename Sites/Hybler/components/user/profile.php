        ...
        if(mysqli_num_rows($gotResults)>0){
            ...
            <form method="POST" action="#">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" value="<?php echo $row['name']; ?>" placeholder="Legg til brukernavn" name="username">
                </div>
                <div class="form-group">
                ...
                <button type="submit" name="submit" value ="update" class="btn">Oppdater</button>
            </form>
