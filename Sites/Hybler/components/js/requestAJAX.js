window.onload = () => {
    ...
    const allHouse = document.querySelectorAll(".req-btn")
    ...
    function addToRequest() {
        ...
        xmlhttp.open("POST", "../request/sendRequest.php", true);
    ...
    allHouse.forEach(function (el) { el.addEventListener('click', addToRequest) });
};